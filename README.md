...
이 저장소는 Planet Gemini 프로젝트에서 구현했던 코드 중 포트폴리오 예시로 정리한 샘플 모음입니다.
...
- [JSON 기반 연구 데이터 관리](./JsonBasedScienceDataManagement/README.md)
- [SearchBatchProcessing 주변 탐색 분산 처리](./SearchBatchProcessing/README.md)
