...
- 상태 데이터는 100개씩 나누어 전송하고, Client의 배치 경계 확인 응답을 기다리는 배치는 최대 5개로 제한했습니다.
- 중간 접속 테스트에서 동기화가 완료되기 전에는 게임 진행을 재개하지 않았고, 완료 후 건물과 벨트 상태가 반영되는 것을 확인했습니다.
